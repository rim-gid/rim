# -*- coding: utf-8 -*-
# Модуль рефакторинга БД. Используется только как вспомогательный при рефакторинге -
# для переноса данных в новые таблицы.

#Перед использованием необходимо откорректировать 
# соответственно новому коду в models.py.
